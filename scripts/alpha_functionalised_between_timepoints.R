...
calc_vegan_table <- function(mpa, metadata){
  ...
  #  dplyr::select(sample_name, sample_id, treatment, replicate, treatment_replicate, timepoint, exp_group, strep_exposure, richness, shannon, simpson, inv_simpson)
  return(alpha_values)
}
...
write.csv(kruskal_results, "reports\\alpha_kruskal_overall_times_groups.csv")

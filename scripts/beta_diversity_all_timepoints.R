...
#write.csv(anosim_df_all, file="reports\\beta_testing_all_timepoints.csv")
#############
# Plots     #
#############
...
p2 <- p2 + expand_limits(y = c(-.2, .2))
plots <- plot_grid(p0, p1, p2, plegend)
plots
ggsave("figures/beta_all_timepoints.pdf", width=29, height=21, dpi=300, units="cm")

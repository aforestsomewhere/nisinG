...
#write outputs
write.csv(anosim_df_all, file="reports\\superfocus3_beta_testing_all_timepoints.csv")
...
write.csv(filt_df_all, file="reports\\superfocus3_beta_testing_T24.csv")
...
sf1_a<- read.csv("reports/superfocus1_beta_testing_all_timepoints.csv")
sf1_a<-sf1_a[,-1]
sf1_24<- read.csv("reports/superfocus1_beta_testing_T24.csv")
sf1_24<-sf1_24[,-1]
sf2_a<- read.csv("reports/superfocus2_beta_testing_all_timepoints.csv")
sf2_a<-sf2_a[,-1]
sf2_24<- read.csv("reports/superfocus2_beta_testing_T24.csv")
sf2_24<-sf2_24[,-1]
sf3_a <- read.csv("reports/superfocus3_beta_testing_all_timepoints.csv")
sf3_a<-sf3_a[,-1]
sf3_24<- read.csv("reports/superfocus3_beta_testing_T24.csv")
sf3_24<-sf3_24[,-1]

list_of_datasets <- list("SF Lvl 1 - all timepoints" = sf1_a,
                         "SF Lvl 2 - all timepoints" = sf2_a,
                         "SF Lvl 3 - all timepoints" = sf3_a,
                         "SF Lvl 1 - T_24" = sf1_24,
                         "SF Lvl 2 - T_24" = sf2_24,
                         "SF Lvl 3 - T_24" = sf3_24)
openxlsx::write.xlsx(list_of_datasets, file = "reports/SUPERFOCUS_beta_diversity.xlsx")

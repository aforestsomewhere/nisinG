...
write.csv(anosim_df_all, file="reports\\beta_testing_T24.csv")
#############
# Plots     #
#############
...
leggo <- plot_ordination(phy, uUF.ordu, type="sites", color="treatment") +
...
#unweighted UNIFRAC
p0 <- plot_ordination(phy, uUF.ordu, type="sites",  color="treatment") +
  scale_color_manual(name="Treatment",
                     labels=c('Control', 
                              expression(paste(italic("F. nucleatum"))), 
                              expression(paste(italic("F. nucleatum/S. salivarius"))), 
...
p1 <- plot_ordination(phy, wUF.ordu, type="sites", color="treatment") +
  scale_color_manual(name="Treatment",
                     labels=c('Control', 
                              expression(paste(italic("F. nucleatum"))), 
                              expression(paste(italic("F. nucleatum/S. salivarius"))), 
...
p1 <- p1 + expand_limits(x = c(-.12,.12), y=c(-.0006,0.0006))
p1
#Bray Curtis

...
anosim_df_all <- data.frame(Data="SUPER-FOCUS level 1", 
...
anosim_df_all <-rbind(anosim_df_all, calc_anosim(dist_mat_ra,group=meta$timepoint, dataset="SUPER-FOCUS level 1", metric="Robust Aitchison Distances", groupname="Timepoint"))
anosim_df_all[-1,]-> anosim_df_all #remove first shaper row (empty)
anosim_df_all <-rbind(anosim_df_all, calc_anosim(dist_mat_ra,group=meta$treatment, dataset="SUPER-FOCUS level 1", metric="Robust Aitchison Distances", groupname="Treatment"))
anosim_df_all <-rbind(anosim_df_all, calc_anosim(dist_mat_ra,group=meta$strep_exposure, dataset="SUPER-FOCUS level 1", metric="Robust Aitchison Distances", groupname="Strep exposure"))
#ADONIS2
# 1. Timepoint, 2. Treatment, 3. Strep exposure
anosim_df_all <-rbind(anosim_df_all, calc_adonis(dist_mat_ra,group=meta$timepoint, dataset="SUPER-FOCUS level 1", metric="Robust Aitchison Distances", groupname="Timepoint"))
anosim_df_all <-rbind(anosim_df_all, calc_adonis(dist_mat_ra,group=meta$treatment, dataset="SUPER-FOCUS level 1", metric="Robust Aitchison Distances", groupname="Treatment"))
anosim_df_all <-rbind(anosim_df_all, calc_adonis(dist_mat_ra,group=meta$strep_exposure, dataset="SUPER-FOCUS level 1", metric="Robust Aitchison Distances", groupname="Strep exposure"))
#Beta dispersion
# 1. Timepoint, 2. Treatment, 3. Strep exposure
anosim_df_all <-rbind(anosim_df_all, calc_disp(dist_mat_ra,group=meta$timepoint, dataset="SUPER-FOCUS level 1", metric="Robust Aitchison Distances", groupname="Timepoint"))
anosim_df_all <-rbind(anosim_df_all, calc_disp(dist_mat_ra,group=meta$treatment, dataset="SUPER-FOCUS level 1", metric="Robust Aitchison Distances", groupname="Treatment"))
anosim_df_all <-rbind(anosim_df_all, calc_disp(dist_mat_ra,group=meta$strep_exposure, dataset="SUPER-FOCUS level 1", metric="Robust Aitchison Distances", groupname="Strep exposure"))
#write outputs
write.csv(anosim_df_all, file="reports\\superfocus1_beta_testing_all_timepoints.csv")
...
p1 <- p1 + expand_limits(x = c(-5, 8), y = c(-1.5, 1.5))
p1
#plot 2 treatment
...
p2
p2 <- p2 + expand_limits(x = c(-3.5, 8), y = c(-1.8, 1.3))
#plot3 - strep exposure
#plot 2 treatment
...
p3 <- p3 + expand_limits(x = c(-3.5, 8), y = c(-1.8, 1.3))
p3
...
filt_df_all <-rbind(filt_df_all, calc_anosim(dist_mat_sf_filt,group=meta_filt$strep_exposure, dataset="SUPER-FOCUS level 1 (T_24)", metric="Robust Aitchison Distances", groupname="Strep exposure"))
...
filt_df_all <-rbind(filt_df_all, calc_adonis(dist_mat_sf_filt,group=meta_filt$strep_exposure, dataset="SUPER-FOCUS level 1 (T_24)", metric="Robust Aitchison Distances", groupname="Strep exposure"))
#Beta dispersion
# 1. Timepoint, 2. Treatment, 3. Strep exposure
...
filt_df_all <-rbind(filt_df_all, calc_disp(dist_mat_sf_filt,group=meta_filt$strep_exposure, dataset="SUPER-FOCUS level 1 (T_24)", metric="Robust Aitchison Distances", groupname="Strep exposure"))

write.csv(filt_df_all, file="reports\\superfocus1_beta_testing_T24.csv")
...
p4 <- p4 + expand_limits(x = c(-3, 7.5),y = c(-0.5, 0.8))
p4
#################
# Testing
#################
...
# plots
# ggsave("figures/beta_functional_lvl1_all_timepoints.pdf", 
#        width=12, height=29, dpi=300, units="cm")

#plot all times and T-24 strep exposure together
plots <- plot_grid(p1, p2, p3, p4, nrow=2, labels="AUTO")

title <- ggdraw() + draw_label("Beta-diversity, SUPER-FOCUS Level 1", fontface='bold')
plots2 <- plot_grid(title, plots, ncol=1, rel_heights=c(0.1, 1)) 
plots2
ggsave("figures\\func_sf1.pdf", plots2, height = 29, width = 21, units = "cm", dpi = 300)

...
anosim_df_all <- data.frame(Data="humann_pathabundance_cpm_unstratified", 
...
anosim_df_all <-rbind(anosim_df_all, calc_anosim(dist_mat_ra,group=meta$timepoint, dataset="humann_pathabundance_cpm_unstratified", metric="Robust Aitchison Distances", groupname="Timepoint"))
anosim_df_all[-1,]-> anosim_df_all #remove first shaper row (empty)
anosim_df_all <-rbind(anosim_df_all, calc_anosim(dist_mat_ra,group=meta$treatment, dataset="humann_pathabundance_cpm_unstratified", metric="Robust Aitchison Distances", groupname="Treatment"))
anosim_df_all <-rbind(anosim_df_all, calc_anosim(dist_mat_ra,group=meta$strep_exposure, dataset="humann_pathabundance_cpm_unstratified", metric="Robust Aitchison Distances", groupname="Strep exposure"))
#ADONIS2
# 1. Timepoint, 2. Treatment, 3. Strep exposure
anosim_df_all <-rbind(anosim_df_all, calc_adonis(dist_mat_ra,group=meta$timepoint, dataset="humann_pathabundance_cpm_unstratified", metric="Robust Aitchison Distances", groupname="Timepoint"))
anosim_df_all <-rbind(anosim_df_all, calc_adonis(dist_mat_ra,group=meta$treatment, dataset="humann_pathabundance_cpm_unstratified", metric="Robust Aitchison Distances", groupname="Treatment"))
anosim_df_all <-rbind(anosim_df_all, calc_adonis(dist_mat_ra,group=meta$strep_exposure, dataset="humann_pathabundance_cpm_unstratified", metric="Robust Aitchison Distances", groupname="Strep exposure"))
#Beta dispersion
# 1. Timepoint, 2. Treatment, 3. Strep exposure
anosim_df_all <-rbind(anosim_df_all, calc_disp(dist_mat_ra,group=meta$timepoint, dataset="humann_pathabundance_cpm_unstratified", metric="Robust Aitchison Distances", groupname="Timepoint"))
anosim_df_all <-rbind(anosim_df_all, calc_disp(dist_mat_ra,group=meta$treatment, dataset="humann_pathabundance_cpm_unstratified", metric="Robust Aitchison Distances", groupname="Treatment"))
anosim_df_all <-rbind(anosim_df_all, calc_disp(dist_mat_ra,group=meta$strep_exposure, dataset="humann_pathabundance_cpm_unstratified", metric="Robust Aitchison Distances", groupname="Strep exposure"))
#write outputs
write.csv(anosim_df_all, file="reports\\humann_unstratified_beta_testing_all_timepoints.csv")
...
p2 <- p2 + expand_limits(x = c(-16, 16), y = c(-10, 10))
p2
#plot 2 treatment
...
p3
p3 <- p3 + expand_limits(x = c(-16, 16), y = c(-10, 10))
#plot 3 strep exposure
p3b = ggplot(pcoa_meta,aes(x = PC1, y = PC2, color=strep_exposure)) + 
...
p3b
p3b <- p3b + expand_limits(x = c(-16, 16), y = c(-10, 10))
...
# 1. Timepoint, 2. Treatment, 3. Strep exposure
#initialise output DF
filt_df_all <- data.frame(Data="humann_unstratified", 
                          Metric="Robust Aitchison Distances",
                          Comparing=NA,
                          Test="ANOSIM",
                          Test_Statistic=NA,
...
filt_df_all <-rbind(filt_df_all, calc_anosim(dist_mat_hm_filt,group=meta_filt$strep_exposure, dataset="humann_unstratified (T_24)", metric="Robust Aitchison Distances", groupname="Strep exposure"))
...
filt_df_all <-rbind(filt_df_all, calc_adonis(dist_mat_hm_filt,group=meta_filt$strep_exposure, dataset="humann_unstratified (T_24)", metric="Robust Aitchison Distances", groupname="Strep exposure"))
#Beta dispersion
# 1. Timepoint, 2. Treatment, 3. Strep exposure
...
filt_df_all <-rbind(filt_df_all, calc_disp(dist_mat_hm_filt,group=meta_filt$strep_exposure, dataset="humann_unstratified (T_24)", metric="Robust Aitchison Distances", groupname="Strep exposure"))

write.csv(filt_df_all, file="reports\\humann_unstratified_beta_testing_T24.csv")
...
p4 <- p4 + expand_limits(x = c(-20,20),y = c(-12, 8))
p4
#################
# Testing
#################

plots <- plot_grid(p2, p3, p3b, p4, nrow=2, labels="AUTO")
plots
ggsave("figures/beta_functional_humann_unstratified_all_timepoints.pdf", 
       width=21, height=21, dpi=300, units="cm")
